...
|---|---|---|---|
| hardware values preserve their evidence class | final target assignment is centralized as SPI2/GPIO12 SCK/GPIO11 MOSI/GPIO13 MISO/GPIO10 CS from the maintainer-reported soldered board; reference resistance, filter, RTD standard, and SPI clock remain required activation configuration; PT100 nominal 100 ohm and three-wire remain fixed | `test_max31865_configuration_policy_requires_explicit_valid_values`; source guardrail | H-pass, B-pass, Guardrail; mapping documented but continuity/electrical values HW-pending |

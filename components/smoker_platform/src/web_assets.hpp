...
<main id="page"><section class="notices" aria-label="Avertismente"><article class="notice simulation"><b>I/O mixt</b><span>Camera folosește MAX31865/PT100; sondele de aliment și heater-ul rămân simulate, fără SSR real.</span></article><article id="default-password" class="notice password hidden"><b>Parolă dispozitiv inițială</b><span>Parola implicită este smoker257500; schimbarea ei este recomandată.</span></article><article class="notice security"><b>HTTP fără TLS</b><span>Loginul local și cookie-ul de sesiune pot fi observate în rețeaua locală.</span></article><article class="notice storage"><b>NVS necriptat</b><span>Credentialele Wi‑Fi sunt stocate necriptat în M12.</span></article></section>

<section id="dashboard" class="dashboard" aria-labelledby="live-title"><div class="section-heading"><div><p class="eyebrow">SESIUNE LIVE · I/O MIXT</p><h2 id="live-title">Controlul afumării</h2></div><span id="session-pill" class="status-pill neutral"><i></i><span>IDLE</span></span></div>
